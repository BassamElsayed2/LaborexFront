...
export default function Section6() {
  return (
    <>
      ...
      <section
        className="vl-before-bg-3 fix pt-100 pb-70"
        data-background=".//assets/img/portfolio/vl-portfolio-bg-3.1.png"
      >
        <div className="container">
          ...
          >
            <div className="col-lg-6 mb-30">
              <div className="box">
                <ImageCompare
                  before={"//assets/img/before/vl-before-3.1.png"}
                  after={"//assets/img/before/vl-after-3.1.png"}
                />
              </div>
            </div>
            <div className="col-lg-6 mb-30">
              <div className="box">
                <ImageCompare
                  before={"//assets/img/before/vl-before-3.2.png"}
                  after={"//assets/img/before/vl-after-3.2.png"}
                />
              </div>
            </div>
          </div>
