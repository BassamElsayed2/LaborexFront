          ...
          <div className="row">
            <div className="col-lg-6 mb-30">
              <div className="vl-banner-area-content3 mt-60">
                ...
                <p
                  ...
                  data-aos-delay={300}
                >
                  Our dedicated team of professionals is committed delivering{" "}
                  <br /> personalized, high-quality dental care comfortable
                  &amp; friendly.
                </p>
                <div
                  className="vl-banner-btn3"
                  data-aos="fade-up"
                  data-aos-duration={800}
                  data-aos-delay={300}
                >
            ...
            <div className="col-lg-4 mb-30">
              <div className="vl-banner-video-thum4b d-none d-lg-block">
                <img
                  className="w-100"
                  src="/assets/img/banner/vl-banner-video-thumb-4.1.png"
                  alt=""
                />
                <div className="video-play-btn3">
                  <Link
                    href="https://www.youtube.com/watch?v=vR24qT-I5ko"
            ...
            <div className="col-lg-4 mb-30">
              <div className="vl-circle-text">
                <Link href="#service">
                  <img
                    className="circle"
                    src="/assets/img/shape/vl-text-circle3.1.svg"
                    alt=""
                  />
                </Link>
                <span>
                        ...
                        <div className="row">
                          <div className="col-lg-6">
                            <div className="vl-form-appointmrnt">
                              ...
                              <select
                                name="select"
                                className="nice-select wide vl-select-date2"
                              >
