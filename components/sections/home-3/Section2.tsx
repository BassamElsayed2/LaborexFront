          ...
          <div className="row">
              ...
              <div className="row">
                  ...
                  <div className="vl-choose-content3">
                    <div className="vl-section-title3">
                      ...
                      <p
                        ...
                        data-aos-delay={300}
                      >
                        We believe building lasting relationships with our
                        patients, taking the time understand your unique needs
                        and goals from preventive care.
                      </p>
                      <div
                        className="vl-choose-btn"
                        data-aos="fade-up"
                        data-aos-duration={800}
                        data-aos-delay={300}
                      >
                ...
                <div className="col-lg-6">
                  <div className="vl-choose-thumb reveal image-anime">
                    <img
                      className="br-8"
                      src="/assets/img/choose/vl-choose-3.1.png"
                      alt=""
                    />
                  </div>
                </div>
            ...
            >
              ...
              <div className="vl-choose-box mb-30">
                ...
                <p className="para">
                  Our team is not only highly skilled but also dedicated to
                  making each patient feel at ease. We understand that dental
                  visits.
                </p>
              </div>
              {/* single box */}
              <div className="vl-choose-box mb-30">
                ...
                <p className="para">
                  We prioritize safety and follow strict sterilization and
                  sanitation protocols to ensure a clean, secure environment
                  additionally.
                </p>
              </div>
              {/* single box */}
              <div className="vl-choose-box mb-30">
                ...
                <p className="para">
                  Whether you need a routine cleaning, restorative care,
                  cosmetic treatments, we offer a full range of dental services
                  to meet all.
                </p>
              </div>
            </div>
