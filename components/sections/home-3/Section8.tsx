...
export default function Section8() {
  ...
  return (
    <>
      ...
      <section
        id="testimonial"
        className="vl-testimonial-bg-3 fix pt-100 pb-100"
      >
            ...
            <div className="col-lg-4">
              <div className="vl-testimonail-large-thumb3 reveal image-anime">
                <img
                  ...
                  src="/assets/img/testimonial/vl-testimonial-large-thumb3.1.png"
                  alt=""
                />
              </div>
            </div>
                ...
                <SwiperSlide className="single-slider1">
                  <div className="slider-box">
                    ...
                    <div className="icon">
                      <ul>
                        <li>
                          <span>
                            <img
                              src="/assets/img/icons/vl-testimonial-review-ic-3.1.svg"
                              alt=""
                            />
                          </span>
                        </li>
                    ...
                    <p className="para pt-20 pb-32">
                      “Our patients’ experience speak for themselves. We’re
                      honored to have helped countless individuals achieve
                      healthier, more confident smiles. Our patients often{" "}
                      <br /> share how much they appreciate gentle approach.”
                    </p>
                  </div>
                    ...
                    <div className="thumb-content-flex">
                      <div className="testimonial-thumb image-anime">
                        <Link href="/testimonial">
                          <img
                            src="/assets/img/testimonial/vl-testimonial-sm-thumb-3.1.png"
                            alt=""
                          />
                        </Link>
                      </div>
                  ...
                  <div className="testimonial-thumb-flx">
                    <div className="thumb-content-flex">
                      <div className="testimonial-thumb image-anime">
                        <Link href="/testimonial">
                          <img
                            src="/assets/img/testimonial/vl-testimonial-sm-thumb-3.2.png"
                            alt=""
                          />
                        </Link>
                      </div>
                  ...
                  <div className="testimonial-thumb-flx">
                    <div className="thumb-content-flex">
                      <div className="testimonial-thumb image-anime">
                        <Link href="/testimonial">
                          <img
                            src="/assets/img/testimonial/vl-testimonial-sm-thumb-3.3.png"
                            alt=""
                          />
                        </Link>
                      </div>
                  ...
                  <div className="testimonial-thumb-flx">
                    <div className="thumb-content-flex">
                      <div className="testimonial-thumb image-anime">
                        <Link href="/testimonial">
                          <img
                            src="/assets/img/testimonial/vl-testimonial-sm-thumb-3.4.png"
                            alt=""
                          />
                        </Link>
                      </div>
