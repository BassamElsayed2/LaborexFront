        ...
        <div className="container">
          ...
          <div className="row">
              ...
              >
                <div className="vl-thumb image-anime">
                  <Link href="/blog-single">
                    <img
                      className="w-100"
                      src="/assets/img/blog/vl-blog4.1.png"
                      alt=""
                    />
                  </Link>
                </div>
                <div className="vl-blog-content">
                  ...
                  <h4 className="title pt-14 pb-24">
                    <Link href="/blog-single">
                      You Only Need to See a Dentist When You Have a <br />{" "}
                      Problem Brushing Harder Cleans Teeth Better
                    </Link>
                  </h4>
            ...
            <div className="col-lg-6">
              {/* single blog item */}
              <div
                className="vl-single-blog-bo4x mb-30"
                data-aos="fade-up"
              ...
              >
                <div className="vl-blog-conten4t">
                  ...
                  <h4 className="title">
                    <Link href="/blog-single">
                      If Your Gums Bleed, You Should Stop Brushing
                    </Link>
                  </h4>
                  <p className="para">
                    If your gums bleed when you brush or floss, it may be sign
                    of gum disease, but that doesn’t mean you should stop
                    brushing.
                  </p>
                  <Link href="/blog-single" className="readmore">
                    Read More
