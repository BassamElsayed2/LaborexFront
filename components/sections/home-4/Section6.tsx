            ...
            >
              ...
              <SwiperSlide className="vl-single-testimonial-bo4x">
                <div className="vl-quote">
                  <img
                    src="/assets/img/shape/vl-testimonial-quote4.1.svg"
                    alt=""
                  />
                </div>
                ...
                <div className="vl-testimonial-content">
                  <p className="para">
                    “We’re grateful of the trust our patients place in us. Many
                    of our patients come to us with fears or insecurities about
                    their smile, and it’s our privilege to help them feel
                ...
                <div className="vl-testimonial-auth-flx">
                  <div className="auth-thumb image-anime">
                    <img
                      src="/assets/img/testimonial/vl-testimonial-auth4.1.png"
                      alt=""
                    />
                  </div>
              ...
              <SwiperSlide className="vl-single-testimonial-bo4x">
                ...
                <div className="vl-testimonial-content">
                  <p className="para">
                    “Our patients consistently share their satisfaction with our
                    care, praising our friendly staff, modern facilities, &amp;
                    the genuine compassion they experience here our community of
                    happy patient.”
                  </p>
                </div>
                <div className="vl-testimonial-auth-flx">
                  <div className="auth-thumb image-anime">
                    <img
                      src="/assets/img/testimonial/vl-testimonial-auth4.2.png"
                      alt=""
                    />
                  </div>
                  <div className="auth-content">
              ...
              <SwiperSlide className="vl-single-testimonial-bo4x">
                ...
                <div className="vl-testimonial-content">
                  <p className="para">
                    “Our top priority is creating welcoming, positive experience
                    for each patient we proud of the feedback we receive from
                    patients who appreciate our dedication to gentle,
                    high-quality care.”
                  </p>
                </div>
                <div className="vl-testimonial-auth-flx">
                  <div className="auth-thumb image-anime">
                    <img
                      src="/assets/img/testimonial/vl-testimonial-auth4.3.png"
                      alt=""
                    />
                  </div>
                  <div className="auth-content">
