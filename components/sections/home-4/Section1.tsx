          ...
          <div className="row">
            <div className="col-lg-8">
              <div className="vl-banner-area-conten4t fix p-relative">
                ...
                >
                  ...
                  enhancements, or advanced <br /> restorative treatment, we’re
                  here to make every step of your journey enjoyable.
                </p>
              </div>
            </div>
            <div className="col-lg-4 p-relative">
              <div className="vl-banne4r-text-widget p-relative">
                {/* widget 1 */}
                <div
                  className="vl-banne4r-widget1 mb-12"
                  data-aos="fade-up"
                  data-aos-duration={800}
                  data-aos-delay={300}
                >
                ...
                >
                  <div className="vl-main-flex">
                    ...
                    <div className="circle-thumb circle">
                      <img
                        src="/assets/img/shape/vl-circle-thunb4.1.svg"
                        alt=""
                      />
                    </div>
                  </div>
              ...
              <div
                className="vl-banne4r-btn mt-32"
                data-aos="fade-up"
      ...
      <div className="vl-banner-thumbnail">
        <div className="container">
          <div className="vl-banner-large-thumb">
            <img
              className="w-100"
              src="/assets/img/banner/vl-banner-thumb-4.1.png"
              alt=""
            />
          </div>
        </div>
