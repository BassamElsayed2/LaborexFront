            ...
            <div className="col-lg-4 col-md-6 mb-30">
              ...
              >
                <div className="icon">
                  <span>
                    <img
                      src="/assets/img/icons/vl-service-icon-4.1.svg"
                      alt=""
                    />
                  </span>
                ...
                <div className="content">
                  ...
                  <p className="para pt-16">
                    Post launch, provide ongoing support, updates, and
            ...
            <div className="col-lg-4 col-md-6 mb-30">
              ...
              >
                ...
                <div className="content">
                  ...
                  <p className="para pt-16">
                    Once the design approved developers bring it to life with
                    clean, responsive.
                  </p>
                </div>
              </div>
            ...
            <div className="col-lg-4 col-md-6 mb-30">
              ...
              >
                ...
                <div className="content">
                  ...
                  <p className="para pt-16">
                    We start learning about your business, your goals, and your
                    target audience.{" "}
                  </p>
                </div>
              </div>
