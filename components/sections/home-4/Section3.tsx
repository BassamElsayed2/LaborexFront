            ...
            >
              ...
              <SwiperSlide className="vl-single-service-bo4x">
                <div className="vl-thumb image-anime">
                  <img
                    className="w-100"
                    src="/assets/img/service/vl-service-thumb-4.1.png"
                    alt=""
                  />
                </div>
                <div className="vl-content">
                  ...
                  <p className="para pt-16">
                    We’re proud offer a comprehensive range of dental service
              ...
              <SwiperSlide className="vl-single-service-bo4x">
                <div className="vl-thumb image-anime">
                  <img
                    className="w-100"
                    src="/assets/img/service/vl-service-thumb-4.2.png"
                    alt=""
                  />
                </div>
                <div className="vl-content">
                  ...
                  <p className="para pt-16">
                    Our Preventive Care services focu regular cleanings, exams,
              ...
              <SwiperSlide className="vl-single-service-bo4x">
                <div className="vl-thumb image-anime">
                  <img
                    className="w-100"
                    src="/assets/img/service/vl-service-thumb-4.3.png"
                    alt=""
                  />
                </div>
                <div className="vl-content">
                  ...
                  <p className="para pt-16">
                    For those in need Restorative Solutions, we offer fillings,
              ...
              <SwiperSlide className="vl-single-service-bo4x">
                <div className="vl-thumb image-anime">
                  <img
                    className="w-100"
                    src="/assets/img/service/vl-service-thumb-4.4.png"
                    alt=""
                  />
                </div>
                <div className="vl-content">
