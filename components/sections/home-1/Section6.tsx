                ...
                <div className="swiper-wrapper">
                  <SwiperSlide className="vl-testimonial-box">
                    ...
                    <div className="vl-testimonial-content">
                      <p className="para">
                        "Working with Recrute was a game-changer for our <br />{" "}
                        finance department. They quickly understood our an{" "}
                        <br /> needs and provided us with highly qualified best
                        to <br /> candidates who not only fit the job
                        description”
                      </p>
                    </div>
                    {/* testimonial auth */}
