            ...
            >
              <div className="vl-service-icon-bo2x text-center">
                <div className="icon">
                  <span>
                    <img
                      src="/assets/img/icons/vl-service-icon-2.1.svg"
                      alt=""
                    />
                  </span>
                </div>
            ...
            >
              <div className="vl-service-icon-bo2x text-center">
                <div className="icon">
                  <span>
                    <img
                      src="/assets/img/icons/vl-service-icon-2.2.svg"
                      alt=""
                    />
                  </span>
                </div>
            ...
            >
              <div className="vl-service-icon-bo2x text-center">
                <div className="icon">
                  <span>
                    <img
                      src="/assets/img/icons/vl-service-icon-2.3.svg"
                      alt=""
                    />
                  </span>
                </div>
            ...
            >
              <div className="vl-service-icon-bo2x text-center">
                <div className="icon">
                  <span>
                    <img
                      src="/assets/img/icons/vl-service-icon-2.4.svg"
                      alt=""
                    />
                  </span>
                </div>
                <div className="content">
                  ...
                  <p className="para">
                    ...
                    treatment, <br />
                    our team is committed to providing gentle, compassionate
                    care <br />
            ...
            >
              <div className="vl-service-icon-bo2x text-center">
                <div className="icon">
                  <span>
                    <img
                      src="/assets/img/icons/vl-service-icon-2.5.svg"
                      alt=""
                    />
                  </span>
                </div>
                <div className="content">
                  ...
                  <p className="para">
                    ...
                    fillings, crowns, <br />
                    bridges, and implants, restoring function and aesthetics to
                    your smile. <br />
