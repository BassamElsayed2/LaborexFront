              ...
              <div className="vl-about-area2 mr-20">
                ...
                <div className="vl-about-thumb-box2 p-relative">
                  <div className="vl-about-area-thumb1 reveal image-anime">
                    <img
                      className="w-100"
                      src="/assets/img/about/vl-about-2.1.png"
                      alt=""
                    />
                  </div>
            ...
            <div className="col-lg-6 mb-30">
              <div className="vl-about-thumb-box3 p-relative">
                <div className="vl-about-area-thumb1 reveal image-anime">
                  <img
                    className="w-100"
                    src="/assets/img/about/vl-about-2.2.png"
                    alt=""
                  />
                </div>
                ...
                >
                  ...
                  health, here to guide you on a journey toward a brighter,
                  healthier. Our dedicated team combines years of experience
                  with a genuine passion for patient care.
                </p>
                {/* btn */}
                <div
                  className="vl-about-btn2"
                  data-aos="fade-up"
                  data-aos-duration={800}
                  data-aos-delay={300}
                >
