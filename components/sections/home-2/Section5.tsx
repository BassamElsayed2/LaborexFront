            ...
            >
              ...
              <SwiperSlide className="vl-single-team-bo2x">
                <div className="team-thumb image-anime">
                  <img
                    className="w-100"
                    src="/assets/img/team/vl-team-thumb-2.1.png"
                    alt=""
                  />
                  {/* team social icon */}
              ...
              <SwiperSlide className="vl-single-team-bo2x">
                <div className="team-thumb image-anime">
                  <img
                    className="w-100"
                    src="/assets/img/team/vl-team-thumb-2.2.png"
                    alt=""
                  />
                  {/* team social icon */}
                  <div className="team-social">
              ...
              <SwiperSlide className="vl-single-team-bo2x">
                <div className="team-thumb image-anime">
                  <img
                    className="w-100"
                    src="/assets/img/team/vl-team-thumb-2.3.png"
                    alt=""
                  />
                  {/* team social icon */}
                  <div className="team-social">
              ...
              <SwiperSlide className="vl-single-team-bo2x">
                <div className="team-thumb image-anime">
                  <img
                    className="w-100"
                    src="/assets/img/team/vl-team-thumb-2.4.png"
                    alt=""
                  />
                  {/* team social icon */}
                  <div className="team-social">
